...
export default function Officers() {
  const { t, officers, addOfficer, updateOfficer, removeOfficer, user } = useApp();
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <input type="email" value={form.email} onChange={e => setForm({ ...form, email: e.target.value })} placeholder="officer@biharpolice.in" className="w-full px-3 py-2 border border-nexus-border rounded-lg text-sm" />
              </div>
              <div>
